...
public class Organization extends TableImpl<OrganizationRecord> {
    ...
    /**
     * The column <code>public.organization.created</code>.
     */
    public final TableField<OrganizationRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.organization.name</code>.
     */
    public final TableField<OrganizationRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(200), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ORGANIZATION_NAME);
    }
