...
public class Keys {
    ...
    public static final ForeignKey<NoteRecord, NoteCategoryRecord> NOTE__NOTE_CATEGORY_ID_FKEY = Internal.createForeignKey(Note.NOTE, DSL.name("note_category_id_fkey"), new TableField[] { Note.NOTE.CATEGORY_ID }, Keys.NOTE_CATEGORY_PKEY, new TableField[] { NoteCategory.NOTE_CATEGORY.ID }, true);
